              ...
              <div className="max-w-7xl mx-auto space-y-6 bg-white py-1">
                <div className="space-y-4">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-neutral-200/50">
                    ...
                    {/* Mode switcher: Occasion vs Garment Types */}
                    <div className="flex items-center gap-1.5 bg-neutral-100/80 p-1 rounded-full border border-neutral-200/60 shrink-0 self-start md:self-auto">
                      <button
                        type="button"
                        onClick={() => setFlowMode('racks')}
                        className={`px-3.5 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-[0.18em] transition-all cursor-pointer ${
                  ...
                  <div className="flex flex-wrap items-center gap-2 pb-2 border-b border-neutral-200/50">
                    {GARMENT_TYPES.map(gt => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-4 py-1.5 rounded-full border text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-200 cursor-pointer flex items-center gap-1.5 ${
                            isSelected 
                              ? 'bg-black border-black text-white shadow-xs' 
                              : 'bg-transparent border-neutral-200/80 text-neutral-600 hover:text-neutral-950 hover:border-neutral-950 hover:bg-neutral-950/5'
                          }`}
